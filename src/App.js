        ...
        <div className="container mx-auto max-w-lg">
          ...
          <div className="text-center">
            <nav>
              ...
              <Link to="/transfer" className="bg-none text-indigo p-0 mr-4 rounded-md hover:none focus:outline-none transition duration-500 ease-in-out">
                IBC Transfer
              </Link>
              <Link to="/datasource" className="bg-none text-indigo p-0 rounded-md hover:none focus:outline-none transition duration-500 ease-in-out">
                Data Source
              </Link>
            </nav>
          </div>
