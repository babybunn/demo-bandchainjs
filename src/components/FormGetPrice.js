          ...
          <div className="mb-5">
            <div className="input-group mb-3">
              ...
              <input
                ...
                value={pairInput}
                onChange={handlePairInput}
              />
            </div>
          </div>
          <button
            onClick={getPrice}
            className="button block w-full bg-yellow-300 text-white py-2 px-4 rounded-md hover:bg-yellow-700 focus:outline-none focus:ring-yellow-600 focus:ring-opacity-50 transition duration-500 ease-in-out"
          >
            Get Price
          </button>
        </div>
