      ...
      <div className="card bg-white p-6 rounded rounded-2xl shadow-indigo shadow-lg">
        ...
        <div className="card-inner">
          ...
          <button
            ...
            className="button block w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-purple-600 focus:ring-opacity-50 transition duration-500 ease-in-out"
          >
            Send BAND
          </button>
        </div>
          ...
          <div>
            {sendResult ? (
              <div className="mt-5 text-red-500">
                <div className="mt-5">{sendResult}</div>
              </div>
            ) : sendResultSuccess ? (
              <div className="mt-3 whitespace-nowrap overflow-ellipsis overflow-hidden">
                <div className="mt-5">
                  Transaction:{" "}
                  <a
                    className="text-indigo-500"
                    href={`https://laozi-testnet4.cosmoscan.io/tx/${sendResultSuccess}`}
                  >
                    {sendResultSuccess}
                  </a>
                </div>
